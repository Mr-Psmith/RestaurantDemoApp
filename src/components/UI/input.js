...
const Input = props => {
    return <div className={classes.input} >
        ...
        <input id={props.inputProps.id} {...props.inputProps} />  {/* So if aI get it well, we made an input prios on the other side as an object, and we are extracting that here  */}
